...
require_once( 'class.suitecrm_contacts.php' );

//http://support.sugarcrm.com/Documentation/Sugar_Developer/Sugar_Developer_Guide_6.5/Application_Framework/Web_Services/Examples/REST/PHP/Creating_or_Updating_a_Record/



class test_suitecrm extends suitecrm_contacts
{
	...
	{
		$this->set( "module_name", "Contacts" );
		$this->set( "description", "Test contact " . date( 'YmdHis' ) );
		$this->set( "name", "Test contact " . date( 'YmdHis' ) );
		$this->set( "last_name",  date( 'YmdHis' ) );
		$this->set( "first_name", "Test contact " );
		...
		//$this->set( "revision", "1" );
		//$this->set( "filename", "example.create_contact.php" );
		//$this->set( "file_upload_path", "example.create_contact.php" );
