...
class crm_sales_delivery extends generic_fa_interface {
	var $id_crm_sales_delivery;	//!< Index of table
...
//		//$this->table_details['foreign'][1] = array( 'column' => "stock_id", 'foreigntable' => "woo_prod_variable_master", "foreigncolumn" => "stock_id", "on_update" => "restrict", "on_delete" => "restrict" );
	...
	function form_crm_sales_delivery
	{
		$this->call_table( 'form_crm_sales_delivery_completed', "crm_sales_delivery" );
	}
	function form_crm_sales_delivery_completed
