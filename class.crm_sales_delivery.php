...
class CrmSalesDelivery extends generic_fa_interface {
    protected $idCrmSalesDelivery; // Renamed to camelCase
    ...
    function formCrmSalesDelivery() {
        $this->call_table('formCrmSalesDeliveryCompleted', "crm_sales_delivery");
    }

    function formCrmSalesDeliveryCompleted() {
