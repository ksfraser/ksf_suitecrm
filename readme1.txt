...
New fields are a little harder, as those are database changes.
  What I do is create fields using SQL entry statements in the fields_meta_data table and running a repair/rebuild to create a field in the appropriate table. I do this instead of using Studio so I can reproduce in production exactly. 
