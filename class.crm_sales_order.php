...
class CrmSalesOrder extends generic_fa_interface {
    protected $idCrmSalesOrder; // Renamed to camelCase
    ...
    function formCrmSalesOrder() {
        $this->call_table('formCrmSalesOrderCompleted', "crm_sales_order");
    }

    function formCrmSalesOrderCompleted() {
