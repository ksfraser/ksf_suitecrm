...
class crm_product extends generic_fa_interface {
	var $id_crm_product;	//!< Index of table
...
//		//$this->table_details['foreign'][1] = array( 'column' => "stock_id", 'foreigntable' => "woo_prod_variable_master", "foreigncolumn" => "stock_id", "on_update" => "restrict", "on_delete" => "restrict" );
	...
	function form_crm_product
	{
		$this->call_table( 'form_crm_product_completed', "crm_product" );
	}
	function form_crm_product_completed
