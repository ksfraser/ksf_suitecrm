...
class crm_sales_quote extends generic_fa_interface {
	var $id_crm_sales_quote;	//!< Index of table
...
//		//$this->table_details['foreign'][1] = array( 'column' => "stock_id", 'foreigntable' => "woo_prod_variable_master", "foreigncolumn" => "stock_id", "on_update" => "restrict", "on_delete" => "restrict" );
	...
	function form_crm_sales_quote
	{
		$this->call_table( 'form_crm_sales_quote_completed', "crm_sales_quote" );
	}
	function form_crm_sales_quote_completed
