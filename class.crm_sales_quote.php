...
class CrmSalesQuote extends generic_fa_interface {
    protected $idCrmSalesQuote; // Renamed to camelCase
    ...
    function formCrmSalesQuote() {
        $this->call_table('formCrmSalesQuoteCompleted', "crm_sales_quote");
    }

    function formCrmSalesQuoteCompleted() {
