...
class crm_customer_branch extends generic_fa_interface {
	var $id_crm_customer_branch;	//!< Index of table
...
//		//$this->table_details['foreign'][1] = array( 'column' => "stock_id", 'foreigntable' => "woo_prod_variable_master", "foreigncolumn" => "stock_id", "on_update" => "restrict", "on_delete" => "restrict" );
	...
	function form_crm_customer_branch
	{
		$this->call_table( 'form_crm_customer_branch_completed', "crm_customer_branch" );
	}
	function form_crm_customer_branch_completed
