...
class CrmSalesInvoice extends generic_fa_interface {
    protected $idCrmSalesInvoice; // Renamed to camelCase
    ...
    function formCrmSalesInvoice() {
        $this->call_table('formCrmSalesInvoiceCompleted', "crm_sales_invoice");
    }

    function formCrmSalesInvoiceCompleted() {
