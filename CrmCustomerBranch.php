...
class CrmCustomerBranch extends generic_fa_interface {
    protected $idCrmCustomerBranch; // Renamed to camelCase
    ...
    function formCrmCustomerBranch() {
        $this->call_table('formCrmCustomerBranchCompleted', "crm_customer_branch");
    }

    function formCrmCustomerBranchCompleted() {
