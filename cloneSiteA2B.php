...
$config_array = array();
$config_array['site_url'] = "https://protect.ksfraser.ca/suitecrm/service/v4_1/soap.php";
$config_array['appname'] = "FA_Integration";
$config_array['soapuser2'] = "admin";
$config_array['pass_hash2'] = md5('m1l1ce');
global $userGUID;
$config_array['site_url2'] = "http://fhsws002.ksfraser.com/devel/fhs/suitecrm/service/v4_1/soap.php";
			...
			foreach( $entries as $arr )
			{
				...
				else
				{
					...
					if( $arr->id == $B->entry_list[0]->id )
					{
						...
						$this->create_task_review_differences();
